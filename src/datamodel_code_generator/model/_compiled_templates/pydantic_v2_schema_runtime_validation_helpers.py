...
# Source: pydantic_v2/schema_runtime_validation_helpers.jinja2 (sha256:5d989f4a147d9905)
...
def render_with_scope(_scope: _Scope) -> str:
    ...
    _context_has_not_required_groups = _scope.get("has_not_required_groups")
    _context_has_pattern_properties = _scope.get("has_pattern_properties")
    _context_has_pattern_property_intersections = _scope.get("has_pattern_property_intersections")
    _context_has_required_groups = _scope.get("has_required_groups")
    _context_has_unique_items = _scope.get("has_unique_items")
    _context_has_unique_items_regex_paths = _scope.get("has_unique_items_regex_paths")
    ...
    if _context_has_not_required_groups:
    ...
    if _context_has_pattern_properties:
        ...
        if _context_has_pattern_property_intersections:
    ...
    if _context_has_conditional_required:
        ...
        if _context_has_conditional_presence:
            _parts.append(
                "\n                any(\n                    name in data\n                    and (\n                        not expected"
            )
            if _context_has_conditional_json_equality:
                _parts.append(
            ...
            _parts.append("\n                    )\n                    for name in names\n                )")
        elif _context_has_conditional_json_equality:
            _parts.append(
                "\n                any(\n                    name in data\n                    and any(\n                        cls._json_schema_conditional_equal(data[name], value)\n                        for value in expected\n                    )\n                    for name in names\n                )"
            )
        else:
    ...
    if _context_has_unique_items:
        ...
        if _context_has_unique_items_regex_paths:
            _parts.append(
