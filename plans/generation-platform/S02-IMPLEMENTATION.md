...
- Second PR: 115 E2E tests, 100% of the three new implementation modules and four new test modules: 923 statements, 230 branches, no missing or partial branches. Existing assertion helpers and external fixtures only; no new assert helper or assertion-policy exemption. Fault injection is limited to abnormal frame/resolver/attempt paths.
