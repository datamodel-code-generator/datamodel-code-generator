...
| [`--custom-file-header-mode`](#custom-file-header-mode) | Choose how a custom file header combines with generated prov... |
...
| [`--strict-dotted-module-names`](#strict-dotted-module-names) | Require canonical Python identifiers when inferring dotted m... |
...
## `--custom-file-header-mode` {#custom-file-header-mode}
...
**Related:** [`--custom-file-header`](#custom-file-header), [`--custom-file-header-path`](#custom-file-header-path), [`--enable-version-header`](#enable-version-header)

!!! tip "Usage"

    ```bash
    datamodel-codegen --input schema.json --custom-file-header "# Copyright {year}" --custom-file-header-mode prepend --disable-timestamp --enable-version-header # (1)!
    ```

    1. :material-arrow-left: `--custom-file-header-mode` - the option documented here
...
## `--strict-dotted-module-names` {#strict-dotted-module-names}
...
!!! tip "Usage"
    ...
    ```bash
    datamodel-codegen --input schema.json --strict-dotted-module-names # (1)!
    ```

    1. :material-arrow-left: `--strict-dotted-module-names` - the option documented here
...
??? example "Examples"
    ...
    **Input Schema:**
    ...
    openapi: 3.0.0
    info:
      title: Invalid dotted schema name
      version: 1.0.0
    paths: {}
    components:
      schemas:
        ...
        SaveRequest:
          ...
          properties:
            ...
            trifecta:
              $ref: '#/components/schemas/SaveTrifectaV2.1'
    ```
