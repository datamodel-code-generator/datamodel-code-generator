...
def _model_0() -> ModelBinding:
    return ModelBinding(
        symbol='variants_reuse_dataclass_models:Owner',
        native_kind='dataclass',
        schema_id=None,
        fields=(
            FieldBinding(
                field_id='variants_reuse_dataclass_models:Owner.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
            ...
            FieldBinding(
                field_id='variants_reuse_dataclass_models:Owner.email',
                native_name='email',
                wire_name='email',
...
def _model_1() -> ModelBinding:
    return ModelBinding(
        symbol='variants_reuse_dataclass_models:Pet',
        native_kind='dataclass',
        schema_id=None,
        fields=(
            FieldBinding(
                field_id='variants_reuse_dataclass_models:Pet.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
                validation_keys=('name',),
            ...
            FieldBinding(
                field_id='variants_reuse_dataclass_models:Pet.id',
                native_name='id',
                wire_name='id',
                validation_key='id',
                validation_keys=('id',),
            ...
            FieldBinding(
                field_id='variants_reuse_dataclass_models:Pet.secret',
                native_name='secret',
                wire_name='secret',
            ...
            FieldBinding(
                field_id='variants_reuse_dataclass_models:Pet.owner',
                native_name='owner',
                wire_name='owner',
                ...
                write_only=False,
                omit_none=True,
                type=ModelNode(symbol='variants_reuse_dataclass_models:Owner'),
            ),
        ),
    )
...
def codec_3() -> PydanticModelCodec[variants_reuse_dataclass_models.FieldOwnersGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema|ArrayNode(item=ModelNode(symbol='variants_reuse_dataclass_models:Owner'), container='list')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1owners/get',
            media_type='application/json',
            backend='pydantic_v2.dataclass',
            native_kind='alias',
            native_export='variants_reuse_dataclass_models:FieldOwnersGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ArrayNode(item=ModelNode(symbol='variants_reuse_dataclass_models:Owner')),
            models=(_model_0(),),
        ),
