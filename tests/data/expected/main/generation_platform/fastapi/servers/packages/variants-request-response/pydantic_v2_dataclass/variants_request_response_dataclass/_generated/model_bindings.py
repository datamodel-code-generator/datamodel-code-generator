...
def _model_0() -> ModelBinding:
    return ModelBinding(
        symbol='variants_request_response_dataclass_models:Owner',
        native_kind='dataclass',
        schema_id=None,
        fields=(
            FieldBinding(
                field_id='variants_request_response_dataclass_models:Owner.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
            ...
            FieldBinding(
                field_id='variants_request_response_dataclass_models:Owner.email',
                native_name='email',
                wire_name='email',
...
def _model_2() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_request_response_dataclass_models:PetResponse.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
                validation_keys=('name',),
            ...
            FieldBinding(
                field_id='variants_request_response_dataclass_models:PetResponse.owner',
                native_name='owner',
                wire_name='owner',
                validation_key='owner',
                validation_keys=('owner',),
...
@cache
def outbound_1() -> NativeOutboundCodec[variants_request_response_dataclass_models.PetResponse]:
...
def codec_3() -> PydanticModelCodec[variants_request_response_dataclass_models.FieldOwnersGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema|ArrayNode(item=ModelNode(symbol='variants_request_response_dataclass_models:Owner'), container='list')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1owners/get',
            media_type='application/json',
            backend='pydantic_v2.dataclass',
            native_kind='alias',
            native_export='variants_request_response_dataclass_models:FieldOwnersGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ArrayNode(item=ModelNode(symbol='variants_request_response_dataclass_models:Owner')),
            models=(_model_0(),),
        ),
