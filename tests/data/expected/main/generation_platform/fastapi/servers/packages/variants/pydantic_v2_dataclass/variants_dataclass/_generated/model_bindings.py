...
def _model_0() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_dataclass_models:Owner.email',
                native_name='email',
                wire_name='email',
...
def _model_1() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_dataclass_models:Pet.id',
                native_name='id',
                wire_name='id',
                validation_key='id',
                validation_keys=('id',),
            ...
            FieldBinding(
                field_id='variants_dataclass_models:Pet.secret',
                native_name='secret',
                wire_name='secret',
            ...
            FieldBinding(
                field_id='variants_dataclass_models:Pet.owner',
                native_name='owner',
                wire_name='owner',
                ...
                write_only=False,
                omit_none=True,
                type=ModelNode(symbol='variants_dataclass_models:Owner'),
            ),
        ),
    )
...
@cache
def codec_0() -> PydanticModelCodec[variants_dataclass_models.Pet]:
    """Codec of /paths/~1pets/post request_body (request application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/components/schemas/Pet|ModelNode(symbol='variants_dataclass_models:Pet')",
            direction='request',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/post/requestBody/content/application~1json/schema',
            operation_id='/paths/~1pets/post',
            media_type='application/json',
            ...
            native_kind='dataclass',
            native_export='variants_dataclass_models:Pet',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='variants_dataclass_models:Pet'),
            models=(_model_0(), _model_1()),
        ),
        variants_dataclass_models.Pet,
        {
            'variants_dataclass_models:Owner': variants_dataclass_models.Owner,
            'variants_dataclass_models:Pet': variants_dataclass_models.Pet,
        },
        request_bundle(),
    )
...
@cache
def codec_1() -> PydanticModelCodec[variants_dataclass_models.Pet]:
...
@cache
def outbound_1() -> NativeOutboundCodec[variants_dataclass_models.Pet]:
...
@cache
def codec_2() -> PydanticModelCodec[variants_dataclass_models.Pet]:
...
@cache
def outbound_2() -> NativeOutboundCodec[variants_dataclass_models.Pet]:
...
@cache
def codec_3() -> PydanticModelCodec[variants_dataclass_models.FieldOwnersGetResponse]:
    """Codec of /paths/~1owners/get response_body (response 200 application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema|ArrayNode(item=ModelNode(symbol='variants_dataclass_models:Owner'), container='list')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1owners/get',
            media_type='application/json',
            backend='pydantic_v2.dataclass',
            native_kind='alias',
            native_export='variants_dataclass_models:FieldOwnersGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ArrayNode(item=ModelNode(symbol='variants_dataclass_models:Owner')),
            models=(_model_0(),),
        ),
...
@cache
def outbound_3() -> NativeOutboundCodec[variants_dataclass_models.FieldOwnersGetResponse]:
