...
def _add_list_pets(router: APIRouter, wiring: Wiring) -> None:
    ...
    router.add_api_route(
        ...
        methods=['GET'],
        status_code=200,
        response_model=pets_basemodel_models.FieldPetsGetResponse,
...
def _add_create_pet(router: APIRouter, wiring: Wiring) -> None:
    ...
    def create_pet(
        *,
        body: Annotated[pets_basemodel_models.NewPet, Body(media_type='application/json')],
    ) -> object:
    ...
    router.add_api_route(
        ...
        methods=['POST'],
        status_code=201,
        response_model=pets_basemodel_models.Pet,
        response_model_by_alias=True,
        response_model_exclude_unset=True,
...
def _add_list_my_pets(router: APIRouter, wiring: Wiring) -> None:
    ...
    router.add_api_route(
        ...
        methods=['GET'],
        status_code=200,
        response_model=pets_basemodel_models.FieldPetsMineGetResponse,
        response_model_by_alias=True,
        response_model_exclude_unset=True,
