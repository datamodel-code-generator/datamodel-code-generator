...
_BUNDLE = r"""{
      ...
      "content": {
       "application/json": {
        "schema": {
         "type": "array",
         "items": {
          "$ref": "#/components/schemas/Pet__1c6e7a0e3146"
         }
        }
       }
      }
       ...
       "application/json": {
        "schema": {
         "anyOf": [
          ...
          {
           "$ref": "#/components/schemas/dcg_validation_error__47804ddc463d"
          }
         ]
        }
       }
 ...
 "components": {
  "schemas": {
   ...
   "dcg_validation_error__47804ddc463d": {
    "type": "object",
    "properties": {
     "detail": {
      "type": "array",
   ...
   "dcg_server_error__47804ddc463d": {
    "type": "string"
   }
  }
 }
