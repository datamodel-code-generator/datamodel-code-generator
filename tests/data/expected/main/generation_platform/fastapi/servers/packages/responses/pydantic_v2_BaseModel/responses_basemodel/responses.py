...
class _GetGreetingResponseCodecs(
    ResponseCodecs[NativeOutboundCodec[responses_basemodel_models.FieldGreetingsGetResponse]],
):
    ...
    ) -> NativeOutboundCodec[responses_basemodel_models.FieldGreetingsGetResponse]: ...
    @overload
    def body(
        self,
        *,
...
class _GetDocumentResponseCodecs(
    ResponseCodecs[NativeOutboundCodec[responses_basemodel_models.Pet]],
):
    ...
    def body(
        ...
        *,
        status_code: Literal[200],
        media_type: Literal['application/json'] | None = None,
    ) -> NativeOutboundCodec[responses_basemodel_models.Pet]: ...
    @overload
    def body(
        self,
        *,
...
GetPetResponsePayload: TypeAlias = (
    ...
    | ModelValue[responses_basemodel_models.Error]
)


_GetPetResponseCodec: TypeAlias = (
    NativeOutboundCodec[responses_basemodel_models.Pet]
    | NativeOutboundCodec[responses_basemodel_models.Error]
)
