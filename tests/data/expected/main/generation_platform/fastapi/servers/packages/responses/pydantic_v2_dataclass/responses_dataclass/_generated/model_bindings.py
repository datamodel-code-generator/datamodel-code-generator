...
def _model_0() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='responses_dataclass_models:Pet.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
...
@cache
def codec_0() -> PydanticModelCodec[responses_dataclass_models.FieldGreetingsGetResponse]:
    """Codec of /paths/~1greetings/get response_body (response 200 application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1greetings/get/responses/200/content/application~1json/schema|LeafNode(representation='value')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1greetings/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1greetings/get',
            media_type='application/json',
            ...
            native_kind='alias',
            native_export='responses_dataclass_models:FieldGreetingsGetResponse',
...
@cache
def outbound_0() -> NativeOutboundCodec[responses_dataclass_models.FieldGreetingsGetResponse]:
...
@cache
def codec_2() -> PydanticModelCodec[responses_dataclass_models.Error]:
...
@cache
def outbound_2() -> NativeOutboundCodec[responses_dataclass_models.Error]:
