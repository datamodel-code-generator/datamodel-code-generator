...
class _CreatePetResponseCodecs(
    ResponseCodecs[NativeOutboundCodec[variants_modular_dataclass_models_pet.Pet]],
):
    ...
    ) -> NativeOutboundCodec[variants_modular_dataclass_models_pet.Pet]: ...
    @overload
    def body(
        self,
        *,
...
class _ListOwnersResponseCodecs(
    ResponseCodecs[NativeOutboundCodec[variants_modular_dataclass_models_field_owners_get_response.FieldOwnersGetResponse]],
):
    ...
    def body(
        ...
        *,
        status_code: Literal[200],
        media_type: Literal['application/json'] | None = None,
    ) -> NativeOutboundCodec[variants_modular_dataclass_models_field_owners_get_response.FieldOwnersGetResponse]: ...
    @overload
    def body(
        self,
        *,
