...
import variants_reuse_basemodel_models
...
def _model_0() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_reuse_basemodel_models:Owner.email',
                native_name='email',
                wire_name='email',
...
def _model_1() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_reuse_basemodel_models:Pet.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
                validation_keys=('name',),
            ...
            FieldBinding(
                field_id='variants_reuse_basemodel_models:Pet.secret',
                native_name='secret',
                wire_name='secret',
            ...
            FieldBinding(
                field_id='variants_reuse_basemodel_models:Pet.owner',
                native_name='owner',
                wire_name='owner',
                ...
                write_only=False,
                omit_none=True,
                type=ModelNode(symbol='variants_reuse_basemodel_models:Owner'),
            ),
        ),
    )
...
@cache
def codec_0() -> PydanticModelCodec[variants_reuse_basemodel_models.Pet]:
    """Codec of /paths/~1pets/post request_body (request application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/components/schemas/Pet|ModelNode(symbol='variants_reuse_basemodel_models:Pet')",
            direction='request',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/post/requestBody/content/application~1json/schema',
            operation_id='/paths/~1pets/post',
            media_type='application/json',
            ...
            native_kind='model',
            native_export='variants_reuse_basemodel_models:Pet',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='variants_reuse_basemodel_models:Pet'),
            models=(_model_0(), _model_1()),
        ),
        variants_reuse_basemodel_models.Pet,
        {
...
@cache
def codec_1() -> PydanticModelCodec[variants_reuse_basemodel_models.Pet]:
...
@cache
def outbound_1() -> NativeOutboundCodec[variants_reuse_basemodel_models.Pet]:
...
@cache
def codec_2() -> PydanticModelCodec[variants_reuse_basemodel_models.Pet]:
...
@cache
def outbound_2() -> NativeOutboundCodec[variants_reuse_basemodel_models.Pet]:
...
@cache
def codec_3() -> PydanticModelCodec[variants_reuse_basemodel_models.FieldOwnersGetResponse]:
    """Codec of /paths/~1owners/get response_body (response 200 application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema|ModelNode(symbol='variants_reuse_basemodel_models:FieldOwnersGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1owners/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='root',
            native_export='variants_reuse_basemodel_models:FieldOwnersGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='variants_reuse_basemodel_models:FieldOwnersGetResponse'),
            models=(_model_2(), _model_0()),
        ),
        variants_reuse_basemodel_models.FieldOwnersGetResponse,
        {
...
@cache
def outbound_3() -> NativeOutboundCodec[variants_reuse_basemodel_models.FieldOwnersGetResponse]:
