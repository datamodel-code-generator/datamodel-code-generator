...
Router untagged of Handlers, with 2 operations.
"""
...
LITERAL_ROUTES: Final = (
    (contract.HandleListPets.OPERATION, _add_handle_list_pets),
    (contract.HandleGetHealth.OPERATION, _add_handle_get_health),
)
