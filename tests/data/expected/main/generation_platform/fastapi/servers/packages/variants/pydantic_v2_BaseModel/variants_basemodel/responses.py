...
class _CreatePetResponseCodecs(
    ResponseCodecs[NativeOutboundCodec[variants_basemodel_models.Pet]],
):
    ...
    ) -> NativeOutboundCodec[variants_basemodel_models.Pet]: ...
    @overload
    def body(
        self,
        *,
...
class _ListOwnersResponseCodecs(
    ResponseCodecs[NativeOutboundCodec[variants_basemodel_models.FieldOwnersGetResponse]],
):
    ...
    def body(
        ...
        *,
        status_code: Literal[200],
        media_type: Literal['application/json'] | None = None,
    ) -> NativeOutboundCodec[variants_basemodel_models.FieldOwnersGetResponse]: ...
    @overload
    def body(
        self,
        *,
