    ...
    return (
        SchemaResource(
            ...
            contents=freeze_wire({
                'paths': {
                    '/maybe': {'get': {'parameters': [{'schema': {'type': 'string'}}]}},
                    '/pets': {
                        'get': {
                            'responses': {
                                '200': {
                    ...
                    '/pets/{petId}': {'put': {'parameters': [{'schema': {'type': 'integer'}}]}},
                },
            }),
            roots=(
                '/paths/~1maybe/get/parameters/0/schema',
                '/paths/~1pets/get/responses/200/content/application~1json/schema',
                '/paths/~1pets~1{petId}/put/parameters/0/schema',
            ),
        ),
    )
...
def _model_0() -> ModelBinding:
    return ModelBinding(
        symbol='security_basemodel_models:FieldPetsGetResponse',
        native_kind='root',
        schema_id=None,
...
@cache
def codec_0() -> PydanticModelCodec[security_basemodel_models.FieldPetsGetResponse]:
    """Codec of /paths/~1pets/get response_body (response 200 application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/200/content/application~1json/schema|ModelNode(symbol='security_basemodel_models:FieldPetsGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1pets/get',
            media_type='application/json',
            ...
            native_kind='root',
            native_export='security_basemodel_models:FieldPetsGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='security_basemodel_models:FieldPetsGetResponse'),
            models=(_model_0(),),
        ),
...
@cache
def outbound_0() -> NativeOutboundCodec[security_basemodel_models.FieldPetsGetResponse]:
