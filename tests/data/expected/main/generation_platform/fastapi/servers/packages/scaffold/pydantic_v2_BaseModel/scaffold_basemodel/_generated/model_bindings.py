...
def _model_0() -> ModelBinding:
    return ModelBinding(
        symbol='scaffold_basemodel_models:FieldPetsGetResponse',
        native_kind='root',
        schema_id=None,
...
@cache
def codec_0() -> PydanticModelCodec[scaffold_basemodel_models.FieldPetsGetResponse]:
    """Codec of /paths/~1pets/get response_body (response 200 application/json)."""
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/200/content/application~1json/schema|ModelNode(symbol='scaffold_basemodel_models:FieldPetsGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1pets/get',
            media_type='application/json',
            ...
            native_kind='root',
            native_export='scaffold_basemodel_models:FieldPetsGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='scaffold_basemodel_models:FieldPetsGetResponse'),
            models=(_model_0(),),
        ),
        scaffold_basemodel_models.FieldPetsGetResponse,
        {'scaffold_basemodel_models:FieldPetsGetResponse': scaffold_basemodel_models.FieldPetsGetResponse},
        response_bundle(),
    )


@cache
def outbound_0() -> NativeOutboundCodec[scaffold_basemodel_models.FieldPetsGetResponse]:
