...
def _model_2() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='pets_basemodel_models:Pet.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
            ...
            FieldBinding(
                field_id='pets_basemodel_models:Pet.tag',
                native_name='tag',
                wire_name='tag',
                validation_key='tag',
                validation_keys=('tag',),
...
def _model_3() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='pets_basemodel_models:Error.message',
                native_name='message',
                wire_name='message',
...
def codec_1() -> PydanticModelCodec[pets_basemodel_models.FieldPetsGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/200/content/application~1json/schema|ModelNode(symbol='pets_basemodel_models:FieldPetsGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1pets/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='root',
            native_export='pets_basemodel_models:FieldPetsGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
...
def codec_2() -> PydanticModelCodec[pets_basemodel_models.Error]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/components/schemas/Error|ModelNode(symbol='pets_basemodel_models:Error')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/get/responses/default/content/application~1json/schema',
            operation_id='/paths/~1pets/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='model',
            native_export='pets_basemodel_models:Error',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
...
def codec_3() -> PydanticModelCodec[pets_basemodel_models.Pet]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/components/schemas/Pet|ModelNode(symbol='pets_basemodel_models:Pet')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets/post/responses/201/content/application~1json/schema',
            operation_id='/paths/~1pets/post',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='model',
            native_export='pets_basemodel_models:Pet',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
...
def codec_4() -> PydanticModelCodec[pets_basemodel_models.FieldPetsMineGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1pets~1mine/get/responses/200/content/application~1json/schema|ModelNode(symbol='pets_basemodel_models:FieldPetsMineGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1pets~1mine/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1pets~1mine/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='root',
            native_export='pets_basemodel_models:FieldPetsMineGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
...
def codec_7() -> PydanticModelCodec[pets_basemodel_models.FieldStoreInventoryGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1store~1inventory/get/responses/200/content/application~1json/schema|ModelNode(symbol='pets_basemodel_models:FieldStoreInventoryGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1store~1inventory/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1store~1inventory/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='root',
            native_export='pets_basemodel_models:FieldStoreInventoryGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
