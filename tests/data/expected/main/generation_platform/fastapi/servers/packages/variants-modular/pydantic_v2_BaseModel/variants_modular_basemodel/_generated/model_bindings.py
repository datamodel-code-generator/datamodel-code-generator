...
import variants_modular_basemodel_models.name as variants_modular_basemodel_models_name
import variants_modular_basemodel_models.owner as variants_modular_basemodel_models_owner
...
def _model_1() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_modular_basemodel_models.owner:Owner.email',
                native_name='email',
                wire_name='email',
...
def _model_2() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_modular_basemodel_models.pet:Pet.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
                validation_keys=('name',),
                ...
                write_only=False,
                omit_none=False,
                type=ModelNode(symbol='variants_modular_basemodel_models.name:Name'),
            ),
            FieldBinding(
                field_id='variants_modular_basemodel_models.pet:Pet.secret',
                native_name='secret',
                wire_name='secret',
            ...
            FieldBinding(
                field_id='variants_modular_basemodel_models.pet:Pet.owner',
                native_name='owner',
                wire_name='owner',
                ...
                write_only=False,
                omit_none=True,
                type=ModelNode(symbol='variants_modular_basemodel_models.owner:Owner'),
            ),
        ),
    )
...
def codec_3() -> PydanticModelCodec[variants_modular_basemodel_models_field_owners_get_response.FieldOwnersGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema|ModelNode(symbol='variants_modular_basemodel_models.field_owners_get_response:FieldOwnersGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1owners/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='root',
            native_export='variants_modular_basemodel_models.field_owners_get_response:FieldOwnersGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='variants_modular_basemodel_models.field_owners_get_response:FieldOwnersGetResponse'),
