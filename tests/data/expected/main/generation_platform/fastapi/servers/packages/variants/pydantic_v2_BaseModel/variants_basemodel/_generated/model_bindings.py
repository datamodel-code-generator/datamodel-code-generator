...
def _model_1() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_basemodel_models:Owner.email',
                native_name='email',
                wire_name='email',
...
def _model_2() -> ModelBinding:
    return ModelBinding(
        ...
        fields=(
            ...
            FieldBinding(
                field_id='variants_basemodel_models:Pet.name',
                native_name='name',
                wire_name='name',
                validation_key='name',
                validation_keys=('name',),
                ...
                write_only=False,
                omit_none=False,
                type=ModelNode(symbol='variants_basemodel_models:Name'),
            ),
            FieldBinding(
                field_id='variants_basemodel_models:Pet.secret',
                native_name='secret',
                wire_name='secret',
            ...
            FieldBinding(
                field_id='variants_basemodel_models:Pet.owner',
                native_name='owner',
                wire_name='owner',
                ...
                write_only=False,
                omit_none=True,
                type=ModelNode(symbol='variants_basemodel_models:Owner'),
            ),
        ),
    )
...
def codec_3() -> PydanticModelCodec[variants_basemodel_models.FieldOwnersGetResponse]:
    ...
    return PydanticModelCodec(
        UseBinding(
            binding_id="https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema|ModelNode(symbol='variants_basemodel_models:FieldOwnersGetResponse')",
            direction='response',
            schema_id='https://dcg.invalid/inputs/root#/paths/~1owners/get/responses/200/content/application~1json/schema',
            operation_id='/paths/~1owners/get',
            media_type='application/json',
            backend='pydantic_v2.BaseModel',
            native_kind='root',
            native_export='variants_basemodel_models:FieldOwnersGetResponse',
            projection_mode='native',
            converter_strategy='pydantic_type_adapter',
            type=ModelNode(symbol='variants_basemodel_models:FieldOwnersGetResponse'),
