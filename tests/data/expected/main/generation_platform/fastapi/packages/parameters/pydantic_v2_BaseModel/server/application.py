...
from .routers import adapters, items
from .services import AdaptersService, ItemsService

ROUTES: Final = (
    *items.LITERAL_ROUTES,
    *adapters.LITERAL_ROUTES,
    *items.TEMPLATED_ROUTES,
    *adapters.TEMPLATED_ROUTES,
)
INFO: Final[FastAPIOptions] = {'title': 'Parameters', 'version': '1.0'}
...
def build_router(
    *,
    ...
    return build(
        ROUTES,
        contract.SCHEMES,
        services={'items': items, 'adapters': adapters},
