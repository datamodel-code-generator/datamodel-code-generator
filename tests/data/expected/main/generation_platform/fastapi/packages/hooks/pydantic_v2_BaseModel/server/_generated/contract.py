...
SchemeKey: TypeAlias = Literal['bearer', 'api_key']
...
class HandlePostUploads:
    """Plans of the handle_post__uploads operation."""

    OPERATION: Final = OperationPlan(
        name='handle_post__uploads',
...
class HandleAddPet:
    """Plans of the handle_add_pet operation."""
...
class HandleGetPet:
    """Plans of the handle_get_pet operation."""
    ...
    class Parameters:
        """The adapter parameters of handle_get_pet."""
