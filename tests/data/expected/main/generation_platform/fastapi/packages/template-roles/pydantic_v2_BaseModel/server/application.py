...
"""Customized: Build the router and the application of every selected operation from the services that implement them."""
...
from .routers import files, pets, untagged
from .services import FilesService, PetsService, UntaggedService

ROUTES: Final = (
    *pets.LITERAL_ROUTES,
    *files.LITERAL_ROUTES,
    *untagged.LITERAL_ROUTES,
    *pets.TEMPLATED_ROUTES,
    *files.TEMPLATED_ROUTES,
...
def build_router(
    *,
    ...
    return build(
        ROUTES,
        contract.SCHEMES,
        services={'pets': pets, 'files': files, 'untagged': untagged},
