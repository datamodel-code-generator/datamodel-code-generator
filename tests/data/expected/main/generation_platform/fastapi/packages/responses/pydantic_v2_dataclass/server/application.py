...
from .routers import files, results
from .services import FilesService, ResultsService

ROUTES: Final = (
    *results.LITERAL_ROUTES,
    *files.LITERAL_ROUTES,
    *results.TEMPLATED_ROUTES,
    *files.TEMPLATED_ROUTES,
)
INFO: Final[FastAPIOptions] = {'title': 'Responses', 'version': '1.0'}
...
def build_router(
    *,
    ...
    return build(
        ROUTES,
        contract.SCHEMES,
        services={'results': results, 'files': files},
