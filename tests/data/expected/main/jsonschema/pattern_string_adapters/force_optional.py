...
class RootItem(_JsonSchemaRuntimeValidationBase):
    ...
    __json_schema_pattern_properties__: ClassVar[tuple[Any, ...]] = (
        {
            'declared_properties': (),
            'rejected_patterns': (),
            'pattern_properties': (('^x', constr(min_length=2, max_length=3)),),
...
class Root(RootModel[list[RootItem] | None]):
    root: list[RootItem] | None = Field(None, title='Root')
