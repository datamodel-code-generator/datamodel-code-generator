...
#   filename:  mapping_schema_validators.json
...
class _JsonSchemaRuntimeValidationBaseCore(BaseModel):
    ...
    def _validate_json_schema_unique_items_path(
        ...
        match path[position]:
            ...
            case (
                '__json_schema_mapping_additional_values__',
...
class Count(_JsonSchemaRuntimeValidationBase):
...
class One(_JsonSchemaRuntimeValidationBaseCore):
    __json_schema_one_of_required_groups__: ClassVar[tuple[Any, ...]] = (
        ((('x',),), (('y',),)),
    )
...
class AnyModel(_JsonSchemaRuntimeValidationBaseCore):
    __json_schema_any_of_required_groups__: ClassVar[tuple[Any, ...]] = (
        ((('x',),), (('y',),)),
    )
...
class Conditional(_JsonSchemaRuntimeValidationBaseCore):
    __json_schema_conditional_required__: ClassVar[tuple[Any, ...]] = (
        {
            'condition': ((('mode',), ('x',)),),
            'then_required_groups': ((('x',),),),
            'else_required_groups': ((('y',),),),
        },
    )
...
class Unique(_JsonSchemaRuntimeValidationBaseCore):
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('items',),),
    )
...
class Nested(_JsonSchemaRuntimeValidationBaseCore):
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('nested',), '__json_schema_mapping_values__'),
    )

    nested: dict[str, list[Any]] | None = None


class Pattern(_JsonSchemaRuntimeValidationBaseCore):
...
class PatternUnique(_JsonSchemaRuntimeValidationBaseCore):
    model_config = ConfigDict(
        extra='allow',
    )
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('__json_schema_mapping_pattern_values__', '^item', None),),
    )
    ...
    __json_schema_pattern_properties__: ClassVar[tuple[Any, ...]] = (
        {
            'declared_properties': ('name',),
            'rejected_patterns': (),
            'pattern_properties': (('^item', list[Any]),),
            'additional_property_type': None,
...
class AdditionalUnique(_JsonSchemaRuntimeValidationBaseCore):
    model_config = ConfigDict(
        extra='allow',
    )
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('__json_schema_mapping_additional_values__', (('name',),), ('^skip',)),),
    )
    ...
    __json_schema_pattern_properties__: ClassVar[tuple[Any, ...]] = (
        {
            'declared_properties': ('name',),
            'rejected_patterns': (),
            'pattern_properties': (('^skip', Any),),
            'additional_property_type': list[Any],
            'allow_unmatched': True,
        },
    )
...
class Root(BaseModel):
    ...
    one: One | None = None
    any: AnyModel | None = None
    conditional: Conditional | None = None
    unique: Unique | None = None
    nested: Nested | None = None
    pattern: Pattern | None = None
    patternunique: PatternUnique | None = None
    additionalunique: AdditionalUnique | None = None
