...
class UniqueItemsConstDraft6(_JsonSchemaRuntimeValidationBase, RootModel[list[int] | Literal['scalar']]):
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (),
    )

    root: list[int] | Literal['scalar'] = Field(..., title='UniqueItemsConstDraft6')