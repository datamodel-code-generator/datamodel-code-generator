...
#   filename:  property_child_conditional_intermediate.json
...
from .conditional_intermediate import ConditionalIntermediate
...
class PropertyChildConditionalIntermediate(
