...
#   filename:  external_core_unique_child.json
...
from .external_core_unique_parent import ExternalCoreUniqueParent
...
class ExternalCoreUniqueChild(
    _JsonSchemaRuntimeValidationBase,
    ExternalCoreUniqueParent,
):
    ...
    __json_schema_pattern_properties__: ClassVar[tuple[Any, ...]] = (
        {
            'declared_properties': ('baseValues',),
            'rejected_patterns': (),
            'pattern_properties': (('^x-', list[int]),),
