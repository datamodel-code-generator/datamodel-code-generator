...
#   filename:  external_core_pattern_child.json
...
from .external_core_pattern_parent import ExternalCorePatternParent
...
class ExternalCorePatternChild(
    _JsonSchemaRuntimeValidationBase,
    ExternalCorePatternParent,
):
    ...
    __json_schema_pattern_properties__: ClassVar[tuple[Any, ...]] = (
        {
            'declared_properties': ('base', 'values'),
            'rejected_patterns': (),
            'pattern_properties': (('^base-', str),),
