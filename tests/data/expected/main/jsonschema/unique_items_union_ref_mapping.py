...
#   filename:  unique_items_union_ref_mapping.json
...
class AnyOfValues(_JsonSchemaRuntimeValidationBase):
    ...
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('__json_schema_mapping_additional_values__', (('kind',),), ()),),
    )

    kind: Literal['inline']


class OneOfValues(_JsonSchemaRuntimeValidationBase):
    model_config = ConfigDict(
        extra='allow',
    )
    __annotations__ = {
...
class UniqueMapping(_JsonSchemaRuntimeValidationBase):
    model_config = ConfigDict(
        extra='allow',
    )
    __annotations__ = {
    ...
    kind: Literal['referenced']


class UniqueItemsUnionRefMapping(_JsonSchemaRuntimeValidationBase):
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('anyOfValues',), ('__json_schema_mapping_additional_values__', (('kind',),), ())),
        (('oneOfValues',), ('__json_schema_mapping_additional_values__', (('kind',),), ())),
    )

    anyOfValues: UniqueMapping | AnyOfValues
    oneOfValues: UniqueMapping | OneOfValues