...
#   filename:  unique_items_additional_aliases.json
...
class AdditionalAliases(_JsonSchemaRuntimeValidationBase):
    ...
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('__json_schema_mapping_additional_values__', (('knownValue', 'known_value'),), ()),),
    )

    known_value: list[int] = Field(..., serialization_alias='known-value')