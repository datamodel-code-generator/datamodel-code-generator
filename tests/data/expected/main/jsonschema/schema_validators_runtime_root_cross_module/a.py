...
from pydantic import ConfigDict, RootModel, constr, model_validator

from .z import BaseModel
...
class RootMixed(_JsonSchemaRuntimeValidationBase, RootModel[str | list[int]]):
    ...
    root: constr(pattern=r'^(?=a).*$') | list[int]
