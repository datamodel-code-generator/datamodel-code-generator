...
#   filename:  unique_items_inline_paths.json
...
class TypedMapping(_JsonSchemaRuntimeValidationBase):
    model_config = ConfigDict(
        extra='allow',
    )
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('__json_schema_mapping_additional_values__', (('known',),), ('^pattern',)),),
    )
...
class PatternMapping(_JsonSchemaRuntimeValidationBase):
    model_config = ConfigDict(
        extra='allow',
    )
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('__json_schema_mapping_pattern_values__', 'List$', None),),
    )
...
class UniqueItemsInlinePaths(_JsonSchemaRuntimeValidationBase):
    __json_schema_unique_items__: ClassVar[tuple[tuple[object, ...], ...]] = (
        (('nestedArray',), None),
        (('nullableAnyOf',),),
    )

    nestedArray: list[list[Any]]
    nullableAnyOf: list[int] | None
    typedMapping: TypedMapping
    patternMapping: PatternMapping


class Model(RootModel[UniqueItemsInlinePaths]):
    root: UniqueItemsInlinePaths
