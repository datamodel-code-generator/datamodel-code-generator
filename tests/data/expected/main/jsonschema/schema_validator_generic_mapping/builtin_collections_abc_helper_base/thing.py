...
from tests.data.python.schema_validator_mapping_base import _collections_abcBase


class _collections_abcBase2Core(BaseModel):
...
class _collections_abcBase2(_collections_abcBase2Core):
...
class Thing(_collections_abcBase2, _collections_abcBase):
