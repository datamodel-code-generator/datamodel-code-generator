...
#   filename:  unique_items_variant_root_alias.json
...
class VariantRootItemRequest(_JsonSchemaRuntimeValidationBase):
    ...
    requestValues: list[int]


class VariantRootItemResponse(_JsonSchemaRuntimeValidationBase):
    model_config = ConfigDict(
        extra='allow',
    )
    __annotations__ = {
    ...
    responseValues: list[int]


VariantRootRequest = TypeAliasType(
    "VariantRootRequest", Annotated[list[VariantRootItemRequest], Field(..., title='VariantRoot')]
)


VariantRootResponse = TypeAliasType(
    "VariantRootResponse", Annotated[list[VariantRootItemResponse], Field(..., title='VariantRoot')]
)