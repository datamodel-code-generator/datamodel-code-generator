...
#   filename:  unique_items_variant_additional.json
...
class VariantAdditionalRequest(_JsonSchemaRuntimeValidationBase):
...
class VariantAdditionalResponse(_JsonSchemaRuntimeValidationBase):
    model_config = ConfigDict(
        extra='allow',
    )
    __annotations__ = {
